...
from transformer_architecture.build_transformer import build_transformer
...
def get_model(config, vocab_src_len, vocab_tgt_len):
    model = build_transformer(vocab_src_len, vocab_tgt_len, config['seq_len'], config['seq_len'], config['d_model'], config['N'], config['h'], config['d_ff'], config['dropout'])
    return model
...
def train_model(config):
    ...
    for epoch in range(init_epoch, config['num_epochs']):
        ...
        for batch in batch_iterator: 
            ...
            decoder_output = model.decode(decoder_input, encoder_mask, decoder_input, decoder_mask) # (B, seq_len, d_model)
